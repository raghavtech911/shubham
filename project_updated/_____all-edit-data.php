...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
            ...
            $sql = "UPDATE tech_candidates
                SET tech_can_fullname = '$name1',
                    ...
                    tech_can_technical_assign = '$tech_assign1',
            ...
            $shubh = "SELECT tech_can_exp_id FROM tech_can_exp WHERE tech_can_id= '$id'";
            $result = $conn->query($shubh);
