...
<head>
  ...
  crossorigin="anonymous"></script>
   <script src="js/hr-edit-validation.js"></script>
    ...
    <div>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <form method="post">
                        ...
                        <input class="input ab" type="text" id="name1" name="name1"  pattern="[a-zA-Z]+[a-zA-Z ]+" value="<?php echo $name;?>"><p><span id="nameerr"></span></p>
                        <br>

                        <input class="input ab" type="email" id="email1" name="email1" value="<?php echo $email; ?>"><p><span id="emailerr"> </span></p>
                        <br>

                        <input type="text" class="input ab" id="phone1" name="phone1" value="<?php echo $mobile; ?>" minlength="10" maxlength="10" pattern="[0123456789][0-9]{9}"><p><span id="phoneerr"> </span></p>
                        <br>

                        <label> Marriage Status * </label>
                        <input type="radio" class="ab" name="mstatus1" value="married" <?php echo ($mstatus=='married' )? 'checked': '' ?>>
                        <label>Married</label>
                        <input type="radio" class="ab" name="mstatus1" value="unmarried" <?php echo ($mstatus=='unmarried' )? 'checked': '' ?>>
                        <label>Unmarried</label>
                        <br>

                        <label> Gender *</label>
                        <input type="radio" class="ab" name="gender1" value="male" <?php echo ($gender=='male' )? 'checked': '' ?>>
                        <label>Male</label>
                        <input type="radio" class="ab" name="gender1" value="female" <?php echo ($gender=='female' )? 'checked': '' ?>>
                        <label>Female</label>
                        <br>

                        <input class="input ab" type="text" id="qual1" name="qual1" value="<?php echo $qual; ?>"><p><span id="qualerr"> </span></p>
                        <br>

                        <input class="input ab" type="text" id="pos1" name="pos1" value="<?php echo $pos; ?>"><p><span id="poserr"> </span></p>
                        <br>
                </div>
            </div>
        </div>
        ...
        <div class="container text-center exp">
            <div class="row">
                ...
                <input class="input ab" type="text" name="notice_period1" value="<?php echo $notice_period[0]; ?>">
                <\t>
                   <select class="dropclass ab" name="period">
                        <option class="ab" id="day" value="day" <?php echo ($notice_period[1] =='day' )? 'selected="selected"': '' ?>>Days</option>
                        <option class="ab" id="month" value="month" <?php echo ($notice_period[1] =='month' )? 'selected="selected"': '' ?>>Months</option>
                    </select>
            </div>
            <!-- end row -->
        </div>
                                ...
                                <\t>
                                    ...
                                    <\t>
                                        <\t>
                                            ...
                                            <br>
                                            <p id="demo"></p>
                                            <input type="submit" id="butn" class="btn btn-primary btn-large" name="updatebtn" value="Update Data">
                                            <\t>
